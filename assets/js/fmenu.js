var fmenu = new Vue({
    ...
    data: {
        ...
        header: ["", "", "ПРИГЛАШЕНИЕ ИГРОКА В ОРГАНИЗАЦИЮ", "ИСКЛЮЧЕНИЕ ИГРОКА ИЗ ОРГАНИЗАЦИИ", "ИЗМЕНЕНИЕ РАНГА ИГРОКА"],
        rigthtext: ["","","ПРИГЛАШЕНИЕ ИГРОКА", "ИСКЛЮЧЕНИЕ ИГРОКА","ИЗМЕНЕНИЕ РАНГА ИГРОКА"],

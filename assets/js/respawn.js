function set(data) {
    ...
    $("#home-spawn .desc-text").text('ПРИ ВЫБОРЕ ДАННОГО МЕСТА СПАВНА ВЫ ПОТЕРЯЕТЕ ВСЁ ОРУЖИЕ');
	}
    ...
    $("#org-spawn .desc-text").text('ПРИ ВЫБОРЕ ДАННОГО МЕСТА СПАВНА ВЫ ПОТЕРЯЕТЕ ВСЁ ОРУЖИЕ');
    } 
}
